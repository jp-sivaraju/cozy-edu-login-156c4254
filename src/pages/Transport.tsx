      ...
      <div className="container mx-auto px-6 py-8 max-w-7xl">
        <div className="flex flex-col space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-[#FF9933]">Transport</h1>
              <p className="text-[#000080] mb-2 text-lg">Manage and track your child's school transportation</p>
            </div>
          </div>

          <Alert className="border-2 border-[#FF9933] bg-[#FFF9F0] shadow-md">
            ...
            <AlertDescription className="text-[#000080]/80">
              ...
              <div className="mt-2">
                <Badge className="bg-[#FF9933]/20 text-[#FF9933] hover:bg-[#FF9933]/30 font-semibold">5 min delay</Badge>
              </div>
            </AlertDescription>
          </Alert>

          <Tabs defaultValue="live" className="w-full" onValueChange={setActiveTab}>
            <TabsList className="grid grid-cols-3 mb-6 bg-white border-2 border-[#138808]/30 p-1 rounded-xl shadow-sm">
              <TabsTrigger 
                value="live" 
                className={`py-3 rounded-lg ${activeTab === 'live' ? 'bg-[#FF9933] text-white font-medium shadow-md' : 'text-[#000080]'}`}>
                <MapPin className="mr-2 h-5 w-5" />
                Live Tracking
              </TabsTrigger>
              <TabsTrigger 
                value="schedule"
                className={`py-3 rounded-lg ${activeTab === 'schedule' ? 'bg-[#FF9933] text-white font-medium shadow-md' : 'text-[#000080]'}`}>
                <CalendarClock className="mr-2 h-5 w-5" />
                Schedule
              </TabsTrigger>
              <TabsTrigger 
                value="route"
                className={`py-3 rounded-lg ${activeTab === 'route' ? 'bg-[#FF9933] text-white font-medium shadow-md' : 'text-[#000080]'}`}>
